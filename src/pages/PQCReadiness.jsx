...
import { getPqcReadiness } from "../services/api";
import { quantumVulnerable, lowerPqcConcern } from "../data/mockData";

export default function PQCReadiness() {
  const [data, setData] = useState(null);

  useEffect(() => {
    getPqcReadiness().then(setData);
  }, []);
